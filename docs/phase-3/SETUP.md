...
You'll see two tabs: **Login** and **Sign Up**
...
4. If successful, you'll see "Account created successfully!" and be redirected to Settings

#### Option B: Login to Existing Account

If you already created an account via Phase 1 API or extension:
...
4. If successful, you'll see the Settings section

#### 3.1 Verify API URL (Optional)
...
#### 3.2 Set Extraction Limit (Optional)
...
**Problem**: "Signup failed" error or validation errors
...
5. **Check validation errors**:
   ...
   - Common errors:
     - "The email has already been taken" - Use different email or login instead
